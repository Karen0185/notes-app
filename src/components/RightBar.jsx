...
const RightBar = ({ thisDayEvents, thisDay, currentEvent, setCurrentEvent, searchResult }) => {
        ...
        <div className="RightBar">
            {
                thisDayEvents.length > 0 ?
                    ...
                    <>
                        ...
                        <h1>{searchResult && searchResult.length == 0 ? isUpcomingEvents ? 'Ближайшие события' : 'Сегодняшние события' : 'Резултаты поиска'}</h1>
                        {
